...
import blue.ocr2.formatter.pdf.PdfBookmarkCmdFormatter;
...
public class BookMarkJComBox {
    ...
    private static PdfBookmarkCmdFormatter[] formatters = {new PdfBookmarkCmdFormatter("111"), new PdfBookmarkCmdFormatter("12"), new PdfBookmarkCmdFormatter("121"), new PdfBookmarkCmdFormatter("21"), new PdfBookmarkCmdFormatter("211"), new PdfBookmarkCmdFormatter("22"), new PdfBookmarkCmdFormatter("221")};
    /**
     * 默认的格式化器,刚开始以第一个为准.
     */

...
public class HotkeyRegister
{
    ...
    private static void dingYiKuaiJieJian()
    {
        ...
        // 截屏 快捷键 ctrl+alt+w
        JIntellitype.getInstance().registerHotKey(SCREENSHOT_HOT_KEY,
                JIntellitype.MOD_CONTROL + JIntellitype.MOD_ALT, 'W');
        // 退出 快捷键 alt+Q
        JIntellitype.getInstance().registerHotKey(EXIT_KEY_MARK,
                JIntellitype.MOD_ALT, 'Q');
        // 取消截屏 快捷键: ctrl+alt+E
        JIntellitype.getInstance().registerHotKey(CANCEL_SCREENSHOT_HOT_KEY,
                JIntellitype.MOD_CONTROL + JIntellitype.MOD_ALT, 'E');
        // 文字识别 快捷键: alt+B
        JIntellitype.getInstance().registerHotKey(BAIDUOCR_HOT_KEY,
                JIntellitype.MOD_ALT, 'B');
        // 书签识别 快捷: alt+s
        JIntellitype.getInstance().registerHotKey(BAIDUOCR_HOT_KEY,

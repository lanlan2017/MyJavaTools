...
images = [
    sys.path[0]+"\\begin_honor+25_wait_KanShiPinZaiZhuan.png",
    sys.path[0]+"\\begin_honor+25_wait_ZaiKanYiGeHuoQu.png",
    sys.path[0]+"\\begin_honor_ZaiKanYiGeHuoDeGengDuo.png"
]

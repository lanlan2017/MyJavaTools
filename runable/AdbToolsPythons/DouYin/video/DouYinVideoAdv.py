...
images = [
    sys.path[0]+"\DouYinVideoAdv_HongBaoOnTop.png",
    sys.path[0]+"\DouYinVideoAdv_HongBaoOnTop2.png",
    sys.path[0]+"\DouYinVideoAdv_HongBaoOnTopClose.png"
]

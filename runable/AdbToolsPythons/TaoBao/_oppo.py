...
images = [
    sys.path[0]+"\exit_oppo+3_wait_JiXuKai.png",
    sys.path[0]+"\exit_oppo_NiuDan_A_KaiXinShouXia.png",
    sys.path[0]+"\exit_oppo_NiuDan_DaCha.png",
    sys.path[0]+"\exit_oppo_NiuDan_NiuDaJiang.png"
]

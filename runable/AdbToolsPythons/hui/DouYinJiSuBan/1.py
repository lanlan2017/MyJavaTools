...
images = [
    ...
    sys.path[0]+"\\begin_+10_A_KanGuangGaoShiPinZaiZhuan_0.png",
    sys.path[0]+"\\begin_+10_A_KanGuangGaoShiPinZaiZhuan_1.png",
    ...
    sys.path[0]+"\\begin_+10_XianShiRenWuZhuanHuoMiao_QuLingQu_1.png",
    sys.path[0]+"\\click_A_LiJiQianDao_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_DianJiLing_0.png",
    sys.path[0]+"\\return_HongGuoMianFeiDuanJu_GuanKanQuanJi_0.png",

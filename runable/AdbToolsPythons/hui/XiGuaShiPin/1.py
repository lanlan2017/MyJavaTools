...
images = [
    ...
    sys.path[0]+"\\begin_+10_A_KanGangGaoShiPinZaiLing.png",
    sys.path[0]+"\\begin_+10_A_KanGangGaoShiPinZaiLing_0.png",
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPinZaiDe_2.png",
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoZaiDe.png",
    sys.path[0]+"\\begin_+10_LingQuJiangLi.png",
    sys.path[0]+"\\begin_+10_LingQuJiangLi_0.png",
    sys.path[0]+"\\begin_Z_+10_KanGuangGaoZhuanJinBi_LingQu.png",
    sys.path[0]+"\\begin_Z_+10_KanGuangGaoZhuanJinBi_LingQu_0.png",

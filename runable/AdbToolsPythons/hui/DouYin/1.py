...
images = [
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPin_QuKanKan.png",
    ...
    sys.path[0]+"\\click_A_QianDao.png",
    sys.path[0]+"\\click_DaCha_0.png",
    ...
    sys.path[0]+"\\return_DanHuaMianFeiXiaoShuo_GuanFangXiaZai.png",

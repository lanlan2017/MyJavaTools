...
images = [
    sys.path[0]+"\\begin_oppo_JiXuGuanKan.png",
    sys.path[0]+"\\begin_oppo_KanShiPinZaiLing.png",
    sys.path[0]+"\\begin_oppo_KanShiPinZaiLing_Hei.png",
    sys.path[0]+"\\begin_oppo_ZaiKanYiGeHuoDe.png"
]

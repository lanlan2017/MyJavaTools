...
images = [
    sys.path[0]+"\\a_begin_+10_FanBeiLingQu.png",
    sys.path[0]+"\\a_click_LiJiQianDao.png",
    sys.path[0]+"\\a_return_GuangJieZhuiDuoZaiLing.png",
    sys.path[0]+"\\begin_+10_FanBeiLingQu.png",
    sys.path[0]+"\\begin_+10_JuXuGuanKan.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_LingFuLi.png",
    sys.path[0]+"\\begin_+10_KanShiPin.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZaiDe_4.png",
    sys.path[0]+"\\begin_+10_KanShiPinZaiDe_5.png",
    sys.path[0]+"\\begin_+10_KanShiPinZaiDe_6.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZaiLing_4.png",
    sys.path[0]+"\\begin_+10_ZaiKanYiGeHuoQu.png",
    sys.path[0]+"\\begin_+10_ZaiKanYiGeHuoQu_.png",
    sys.path[0]+"\\begin_+10_ZaiKanYiGeHuoQu_0.png",
    sys.path[0]+"\\click_A_DaCha.png",
    sys.path[0]+"\\click_A_KaiXinShouXIa.png",
    sys.path[0]+"\\click_KanWenZhangHuoShiPinZhuanJinBi_DianJiLingQu.png",
    sys.path[0]+"\\click_LingQuChengGongTiaoGuo.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_2.png",
    sys.path[0]+"\\return_DianTao.png",
    sys.path[0]+"\\return_LingQuChengGong.png"
]

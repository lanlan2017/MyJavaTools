...
images = [
    sys.path[0]+"\\a_click_TingShuZhuanJinBi_LiJiLingQu.png",
    sys.path[0]+"\\a_click_TingShuZhuanJinBi_LiJiLingQu_0.png",
    ...
    sys.path[0]+"\\click_Z_KaiBaoXiang——0.png"
]

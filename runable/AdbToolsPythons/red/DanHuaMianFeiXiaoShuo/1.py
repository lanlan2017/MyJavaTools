...
images = [
    ...
    sys.path[0]+"\\begin_+10_A_KanShiPinZhaiLing_0.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZhuiGaoZaiLing_0.png",
    sys.path[0]+"\\begin_+10_ChiFanBuTie_KanShiPinZaiLing.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZaiLing_3.png",
    sys.path[0]+"\\begin_+10_KanShiPinZhuanJinBi.png",
    sys.path[0]+"\\begin_+10_KanShiPinZhuanJinBi_0.png",
    sys.path[0]+"\\begin_+10_KanShiPinZhuanJinBi_1.png",
    ...
    sys.path[0]+"\\begin_+10_Z_KanShiPinBuLingYiCiBuTie.png",
    sys.path[0]+"\\begin_+10_Z_KanShiPinBuLingYiCiBuTie_0.png",
    sys.path[0]+"\\begin_+10_Z_KanShiPinBuLingYiCiBuTie_1.png",
    sys.path[0]+"\\click_+10_LiJiLingQu_2.png",
    sys.path[0]+"\\click_A_ChiFanBuTie_LingChiFanBuTie.png",
    sys.path[0]+"\\click_A_ChiFanBuTie_LingWanFanBuTie.png",
    sys.path[0]+"\\click_A_ChiFanBuTie_LingWanFanBuTie_0.png",
    ...
    sys.path[0]+"\\click_A_KanDuanJuZhuanJinBi_LiJiLingQu.png",
    ...
    sys.path[0]+"\\return_ChiFanBuTie_HouLingWanFanBuTie.png",
    sys.path[0]+"\\return_ChiFanBuTie_HouLingYeXiaoBuTie.png"
]

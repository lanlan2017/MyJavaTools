...
images = [
    ...
    sys.path[0]+"\\begin_+10_LingQuJiangLi-0.png",
    sys.path[0]+"\\begin_+10_LingQuJiangLi.png",
    sys.path[0]+"\\begin_XianShiReWuZhuanJinBi_QuLingQu_0.png",
    sys.path[0]+"\\begin_XianShiReWuZhuanJinBi_QuLingQu_1.png",
    sys.path[0]+"\\begin_XianShiReWuZhuanJinBi_QuLingQu_2.png",
    sys.path[0]+"\\click_A_HaoDe.png",
    sys.path[0]+"\\click_HongBaoGuaJian.png",

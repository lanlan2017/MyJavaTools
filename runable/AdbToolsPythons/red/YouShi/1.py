...
images = [
    ...
    sys.path[0]+"\\begin_+10_KanShiPinLingBuTie.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZaiD_1.png",
    ...
    sys.path[0]+"\\begin_+10_Z_KanGuangGaoZhuanJinBi_LingFuLi.png",
    sys.path[0]+"\\begin_KanShiPinLing.png",
    sys.path[0]+"\\click_KaiBaoXiangZhuanJinBi.png",
    sys.path[0]+"\\click_QianDaoLingJinBi.png",
    sys.path[0]+"\\return_QiCheZhiJia.png"
]

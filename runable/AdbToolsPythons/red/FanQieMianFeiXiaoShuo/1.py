...
images = [
    sys.path[0]+"\\a_click_KanXinShouXia.png",
    ...
    sys.path[0]+"\\begin_+10_A_KanShiPinZhuanJinBi_LiJiLingqQu.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZhuiGaoZaiLing.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZhuiGaoZaiLing_0.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZhuiGaoZaiLing_1.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZhuiGaoZaiLing_2.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZuiGaoZaiLing_2.png",
    sys.path[0]+"\\begin_+10_KanShiPinZuiGaoZaiLing_3.png",
    ...
    sys.path[0]+"\\click_A_LiJiLingQu.png",
    ...
    sys.path[0]+"\\click_A_TingShuZhuanJinBi_LiJiLingQu_3.png",
    sys.path[0]+"\\click_A_TingShuZhuanJinBi_LiJiLingQu_4.png",
    sys.path[0]+"\\click_A_YueDuZhuanJinBi_LiJiLingQu.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\return_HouLingWanFanBuTie.png",
    sys.path[0]+"\\return_ZhiBoGouWuChe.png"
]

...
images = [
    sys.path[0]+"\\a_click_HongBaoGuaJian.png",
    sys.path[0]+"\\a_click_LiJiQianDao_0.png",
    sys.path[0]+"\\a_click_LiJiQianDao_1.png",
    sys.path[0]+"\\a_click_QianDaoDe_0.png",
    sys.path[0]+"\\a_click_QianDaoDe_1.png",
    sys.path[0]+"\\a_click_QianDaoDe_2.png",
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPinZaiZhuan_4.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPin_QuKanKan_0.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPin_QuKanKan_1.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPin_QuKanKan_2.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPin_QuKanKan_3.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPin_QuKanKan_4.png",
    sys.path[0]+"\\begin_+10_LingQuJiangLi.png",
    sys.path[0]+"\\click_A_KaiXinShouXia.png",
    sys.path[0]+"\\click_A_PingJiaBingShouXiaJinBi.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_1.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_2.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_3.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_4.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_5.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_6.png"
]

...
images = [
    ...
    sys.path[0]+"\\a_return_KanZhiBoKaiBaoXiang_1.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinLingQu_2.png",
    sys.path[0]+"\\begin_+10_KanShiPinLingQu_3.png",
    sys.path[0]+"\\begin_+10_KanShiPinLingQu_4.png",
    ...
    sys.path[0]+"\\begin_+10_ZaiKanYiTiaoLing_1.png",
    sys.path[0]+"\\begin_A_+10_KanShiPin_0.png",
    sys.path[0]+"\\begin_JiXuGuanKan_).png",
    sys.path[0]+"\\click_GuangGao_DaCha_0.png",
    sys.path[0]+"\\click_GuangGao_TiaoGuo_0.png",
    sys.path[0]+"\\click_GuangGao_TiaoGuo_1.png",
    sys.path[0]+"\\click_YuanQiu_0.png",
    sys.path[0]+"\\click_YuanQiu_1.png",
    sys.path[0]+"\\click_YuanQiu_2.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_).png"
]

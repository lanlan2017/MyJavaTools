...
images = [
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_LiJiLingQu_0.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_QuLingQu_0.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_QuLingQu_1.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_QuLingQu_2.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_QuLingQu_3.png",

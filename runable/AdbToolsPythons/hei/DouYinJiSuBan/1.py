...
images = [
    ...
    sys.path[0]+"\\a_click_PingJiaBingShouXiaJinBi.png",
    sys.path[0]+"\\a_click_PingJiaBingShouXiaJinBi_1.png",
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_QuLingQu.png",
    ...
    sys.path[0]+"\\return_HongGuoMianFeiDuanJu_GuanKanQuanJi.png",
    sys.path[0]+"\\return_LiJiXiaZai_0.png",
    sys.path[0]+"\\return_LiJiXiaZai_1.png",
    sys.path[0]+"\\return_PinDuoDuo_XiaZaiDaKaiDe.png"
]

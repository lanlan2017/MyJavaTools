...
images = [
    sys.path[0]+"\\begin_+10_A_EWaiZaiLing_0.png",
    sys.path[0]+"\\begin_+10_A_FanBeiLingQu.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZaiLing.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZaiLing_0.png",
    sys.path[0]+"\\begin_+10_A_ZaiKanYiGeHuoQu.png",
    ...
    sys.path[0]+"\\begin_+10_Z_KanGuangGaoZhuanJiBi_LingFuLi.png",
    sys.path[0]+"\\click_A_KanWanZhangHuoShiPinZhuanJinBi_DianJiLingQu.png",
    sys.path[0]+"\\click_A_KanWanZhangHuoShiPinZhuanJinBi_KaiXinShouXia.png",
    sys.path[0]+"\\click_A_KanWanZhangHuoShiPinZhuanJinBi_KaiXinShouXia_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\return_GuangJieZaiLing.png",

...
images = [
    ...
    sys.path[0]+"\\begin_+10_A_KanShiPinZaiZhuan.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPinZaiZhuan.png",
    sys.path[0]+"\\begin_+10_LingQuJiangLi.png",
    sys.path[0]+"\\begin_+10_QuLingQu.png",
    sys.path[0]+"\\begin_+10_QuLingQu_0.png",
    sys.path[0]+"\\click_A_HaoDe_0.png",

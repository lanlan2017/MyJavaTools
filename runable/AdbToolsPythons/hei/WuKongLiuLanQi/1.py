...
images = [
    ...
    sys.path[0]+"\\a_click_WoZhiDaoLe_0.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPin_2.png",
    sys.path[0]+"\\begin_+10_KanShiZaiDe.png",
    sys.path[0]+"\\begin_+10_KanShiZaiDe_0.png",
    sys.path[0]+"\\begin_+10_ZaiKanYiGeLing_0.png",
    sys.path[0]+"\\begin_+10_ZaiKanYiTiaoLing.png",
    sys.path[0]+"\\click_A_KaiXinShouXia.png",
    sys.path[0]+"\\click_A_LiJiLingQu.png",
    sys.path[0]+"\\click_A_YuanQiu.png",

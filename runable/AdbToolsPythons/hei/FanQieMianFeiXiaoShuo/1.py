...
images = [
    ...
    sys.path[0]+"\\begin_+10_A_KanShiPinZuiGaoZaiLing.png",
    sys.path[0]+"\\begin_+10_JiXuGuanKan.png",
    sys.path[0]+"\\begin_+10_JiXuGuanKan_0.png",
    sys.path[0]+"\\begin_+10_KanShiPinZhuanJiBi_LiJiLingQu.png",
    ...
    sys.path[0]+"\\begin_+10_LingQuJiangLi_4.png",
    ...
    sys.path[0]+"\\return_GuangGao_DouBao_LiJiXiaZai.png"
]

...
images = [
    ...
    sys.path[0]+"\\begin_JiXuGunKan.png",
    sys.path[0]+"\\begin_KanGuanGaoShiPinZaiLing.png",
    sys.path[0]+"\\begin_KanGuanGaoShiPinZaiLing_0.png",
    sys.path[0]+"\\begin_KanGuangGaoZhuanJinBi_LingQu.png",
    sys.path[0]+"\\begin_LingQuJiangLi.png",

...
images = [
    sys.path[0]+"\\a_click_QianDaoLingJinBi_0.png",
    sys.path[0]+"\\a_click_QianDaoLingJinBi_1.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinLing.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZhaiLing.png",
    sys.path[0]+"\\begin_+10_A_KanShiPinZhaiLing_0.png",
    sys.path[0]+"\\begin_+10_ChiFanBuTie_KanShiPinLingBuTie.png",
    sys.path[0]+"\\begin_+10_ChiFanBuTie_KanShiPinLingBuTie_0.png",
    ...
    sys.path[0]+"\\begin_+10_KanShiPinZaiZhuan.png",
    sys.path[0]+"\\begin_+10_KanShiPinZaiZhuan_0.png",
    sys.path[0]+"\\begin_+10_KanShiPinZaiZhuan_1.png",
    sys.path[0]+"\\click_A_QianDaoLingJinBi.png",

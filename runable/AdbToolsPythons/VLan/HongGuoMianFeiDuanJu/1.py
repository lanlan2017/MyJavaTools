...
images = [
    ...
    sys.path[0]+"\\begin_+10_ChiFanBuTie_KanShiPinZaiLing_1.png",
    ...
    sys.path[0]+"\\begin_+10_Z_ChiFanBuTie_KanShiPinBuLingYiCiBuTie_0.png",
    sys.path[0]+"\\click_ChiFanBuTie_QuLingQu_0.png",
    sys.path[0]+"\\click_ChiFanBuTie_QuLingQu_1.png",
    sys.path[0]+"\\click_ChiFanBuTie_Z_LingYeXiaoBuTie_0.png",
    sys.path[0]+"\\click_LiJiLingQu_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_1.png",
    sys.path[0]+"\\click_Z_Z_GuangGao_GuanBi_0.png"
]

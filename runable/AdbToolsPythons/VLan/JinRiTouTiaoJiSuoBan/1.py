...
images = [
    sys.path[0]+"\\a_begin_EWaiZaiLing.png",
    sys.path[0]+"\\a_click_KaiXinShouXia.png",
    sys.path[0]+"\\a_click_KanWenZhangHuoShiPinZhuanJinBi_DianJiLingQu_0.png",
    sys.path[0]+"\\a_return_GuangJieZuiDuoZaiLing.png",
    sys.path[0]+"\\begin_+10_A_FanBeiLingQu_0.png",
    sys.path[0]+"\\begin_+10_JiXuKanShiPinZaiLing.png",
    ...
    sys.path[0]+"\\begin_+10_ShuiJiao_LingQu.png",
    sys.path[0]+"\\begin_+15_ZaiKanYiGeHuoQu.png",
    sys.path[0]+"\\click_WoShuiXingLe.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_1.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_2.png",
    sys.path[0]+"\\click_Z_ShuiJiao_LingQu.png",
    sys.path[0]+"\\click_Z_ShuiJiao_WoShuiXingLe.png",
    sys.path[0]+"\\return_JinRuZhiBo.png",
    sys.path[0]+"\\return_JinRuZhiBo_0.png",
    sys.path[0]+"\\return_LiJiXiaZai.png"
]

...
images = [
    sys.path[0]+"\\a_click_HaoDe.png",
    sys.path[0]+"\\a_click_LiJiQianDao.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPinZaiZhuan.png",
    ...
    sys.path[0]+"\\begin_+10_XianShiRenWuZhuanHuoMiao_QuLingQu.png",
    sys.path[0]+"\\begin_+10_XianShiRenWuZhuanHuoMiao_QuLingQu_0.png",
    sys.path[0]+"\\click_A_HongBaoGuaJian.png",
    sys.path[0]+"\\click_A_LiJiQianDao.png",
    sys.path[0]+"\\click_A_QuQianDao.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang.png",
    sys.path[0]+"\\return_DaKaiQianDaoTiXing.png"
]

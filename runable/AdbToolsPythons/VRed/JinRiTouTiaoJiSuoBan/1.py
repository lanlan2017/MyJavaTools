...
images = [
    ...
    sys.path[0]+"\\a_return_GuangJieZhuiDuoZaiLing_0.png",
    sys.path[0]+"\\a_return_GuangJieZhuiDuoZaiLing_1.png",
    sys.path[0]+"\\a_return_GuangJieZhuiDuoZaiLing_2.png",
    sys.path[0]+"\\begin_+10_A_FanBeiLingQu_0.png",
    sys.path[0]+"\\begin_+10_EWaiZaiLing_0.png",
    ...
    sys.path[0]+"\\begin_+10_Z_KanGuangGaoZhuanJinBi_LingFuLi_0.png",
    sys.path[0]+"\\begin_+10_Z_KanGuangGaoZhuanJinBi_LingFuLi_1.png",
    sys.path[0]+"\\click_A_KanWenZhangHuoShiPinZhuanJinBi_DianJiLingQu_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_1.png",
    sys.path[0]+"\\return_GuangGao_AnQuanXiaZai_0.png",
    sys.path[0]+"\\return_GuangGao_FanYi_0.png",
    sys.path[0]+"\\return_GuangGao_LiJiDaKai_0.png",
    sys.path[0]+"\\return_GuangGao_LiJiXiaZai_0.png",
    sys.path[0]+"\\return_ZhiBo_GouWuChe_0.png",
    sys.path[0]+"\\return_ZhiBo_GuanZhu_0.png",
    sys.path[0]+"\\return_ZhiBo_LiuLanGengDuoZhiBo_0.png"
]

...
images = [
    ...
    sys.path[0]+"\\a_click_KaiXinShouXia_2.png",
    ...
    sys.path[0]+"\\begin_+10_KanGuangGaoShiPinZaiLing_2.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_LingQu.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_LingQu_0.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_LingQu_1.png",
    sys.path[0]+"\\begin_+10_KanGuangGaoZhuanJinBi_LingQu_3.png",
    sys.path[0]+"\\begin_+10_LingQuJiangLi.png",
    sys.path[0]+"\\click_A_KanShiPinZhuanJinBi_KeLingQu.png",
    sys.path[0]+"\\click_A_KanShiPinZhuanJinBi_KeLingQu_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_0.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_1.png",
    sys.path[0]+"\\click_Z_KaiBaoXiang_2.png",
    sys.path[0]+"\\return_ChaKanXiangQing_0.png",

...
images = [
    sys.path[0]+"\exit_honor_WuChuKong_ChangAn.png",
    sys.path[0]+"\exit_honor_WuChuKong_ChangAn2.png",
    sys.path[0]+"\stop_honor_DianJiFanBei.png"
]

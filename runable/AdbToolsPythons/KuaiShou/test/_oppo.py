...
images = [
    sys.path[0]+"\click_oppo_qiang0.png",
    sys.path[0]+"\click_oppo_qiang1.png",
    sys.path[0]+"\click_oppo_qiang4.png",
    sys.path[0]+"\click_oppo_s10.png"
]

...
images = [
    sys.path[0]+"\\begin_oppo_A_KanWanShiPinZaiLing.png",
    sys.path[0]+"\\begin_oppo_A_LiJiLingQu.png",
    sys.path[0]+"\\begin_oppo_A_LiJiLingQu0.png",
    sys.path[0]+"\\begin_oppo_A_LiJiLingQu1.png",
    sys.path[0]+"\\begin_oppo_A_LiJiLingQu2.png",

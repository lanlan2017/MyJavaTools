...
public class MyScript {
    ...
    private MyScript() {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(Resource2InputStream.relativePath(this.getClass(), "MyScript.html"), StandardCharsets.UTF_8))) {

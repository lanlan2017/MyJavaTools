...
public class WaitValues {
    public static int[] values = {5, 8, 10, 15, 20, 30, 35, 65, 95, 120, 150, 3 * 60, 3 * 60 + 30, 4 * 60, 4 * 60 + 30, 5 * 60, 10 * 60, 12 * 60, 15 * 60, 20 * 60, 30 * 60, 40 * 60, 50 * 60, 60 * 60, 2 * 60 * 60, 3 * 60 * 60, 3 * 60 * 60 + 10 * 60};
    // static String[] valueStrs = {"5", "8", "10", "15", "20", "30", "35", "65", "95", "120", "150", "3m", "3m+30", "4m", "4m+30", "5m", "10m", "12m", "15m", "20m", "30m", "40m", "50m", "1h", "2h", "3h", "3h+"};
    public static String[] valueStrs = {"", "", "", "", "", "", "", "", "", "2m", "2.5m", "3m", "3m+30", "4m", "4m+30", "5m", "10m", "12m", "15m", "20m", "30m", "40m", "50m", "1h", "2h", "3h", "3h+"};

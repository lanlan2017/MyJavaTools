...
//             System.out.println("isRunning instanceof ClosableRunnable = " + (isRunning instanceof ClosableRunnable));
//             if ((isRunning instanceof ClosableRunnable)) {
//                 ClosableRunnable closableRunnable = (ClosableRunnable) isRunning;
//                 System.out.println("closableRunnable stop:" + closableRunnable);
//                 closableRunnable.setStop(true);
//                 continue;
//             }
//             // 如果是视频线程正在运行的话
...
//             } else if (isRunning instanceof DouYinTaskRunnable) {
//                 DouYinTaskRunnable.setStop(true);
//             }
//
//             iterator.remove();
//         }
